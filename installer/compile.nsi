; ========================================
; BTA Launcher NSIS Installer Script
; ========================================
; Requirements:
;   - NSIS 3.x installed
;   - Build output in "output-build" folder
;
; Usage:
;   1. Run compile-windows.bat first
;   2. Open NSIS and compile this script
; ========================================
